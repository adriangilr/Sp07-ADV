...
Aplicación en python con streamlit y corriendo en render (https://sp07-adv.onrender.com) para analizar el comportamiento del precio de vehiculos usados en funcion de:
